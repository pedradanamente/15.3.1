<html>
 ...
 <body>
  <form action="index.php?url=sending&acao=enviar&opcao=textarea" method="post" enctype="multipart/form-data">
   <table width="100%" border="0">
    <tr>
     <td>
      <!-- MENSAGEM EM HTML -->
      <div class="X5" style="clear:both;">
        Mensagem c/ Formatação:
      </div>
      <div class="X6" style="clear:both;">
	<textarea class="textareaX4" id="elm1" name="textarea" rows="110" cols="15" ><?php if (isset($_SESSION['textarea'])){ echo $_SESSION['textarea']; }else {?><?php } ?></textarea>
      </div>
      <!-- Destinatários -->
      <div class="X1">
